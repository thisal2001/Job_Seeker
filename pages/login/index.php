...
<body>
    ...
    <main id="container">
        ...
        <h1 class="text-center my-4">Login as a :</h1>
        <hr class="underliner">
        ...
        <div class="content-wrapper">
            <div class="col">
                ...
                <a href="<?php echo BASE_URL?>/pages/login/recruiter.php" class="d-flex justify-center">
                    <button class="btn button-filled">Login as a Recruiter</button>
                </a>
            </div>
            <div class="col2">
                ...
                <a href="<?php echo BASE_URL?>/pages/login/candidate.php" class="d-flex justify-center">
                    <button class="btn button-filled">Login as a Job Candidate</button>
                </a>
            </div>
        </div>
