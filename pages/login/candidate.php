<?php
    ...
    function main(){
        ...
        $_SESSION['canId'] = $canId;

        echo "<script>alert('Logged in sucessfully. Click ok to access your dashboard.'); window.location.href='/jobseeker/pages/candidate/';</script>";
...
<body>
    ...
    <main id="container">
        ...
        <div class="col candidate-bg d-sm-none d-md-none"></div>

        <div class="col2">
            <br>
            <h1 class="text-center my-4">Job Candidate Login</h1>
            <hr class="underliner">
