...
<body>
    ...
    <main id="container">
        ...
        <h1 class="text-center my-4">Candidate Dashboard</h1>
        <hr class="underliner">
        <p class="text-center my-6">Hello candidate 👋. Ready to find your next job.</p>

        <br><br>

        <div id="content" class="d-flex">
            <div class="col">
                <a class="point" href="<?php echo BASE_URL?>/pages/jobs/">
                    <img class="icon-xs" src="<?php echo BASE_URL?>/assets/svg/tick.svg" alt="">
                    <p>Browse Jobs</p>
                </a>
                <a class="point" href="<?php echo BASE_URL?>/pages/candidate/profile.php">
                    <img class="icon-xs" src="<?php echo BASE_URL?>/assets/svg/tick.svg" alt="">
                    <p>Visit Pofile</p>
                </a>
            </div>
            ...
            <div class="col2">
                <img class="icon-xl d-block mx-auto" src="<?php echo BASE_URL?>/assets/illustrations/working_remotely.svg" alt="dasboard-illustration">
            </div>
        </div>
