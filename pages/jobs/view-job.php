...
<title>JobSeeker - View Verified Job</title>
...
<main id="container">
    ...
    <h1 class="text-center my-4">Job Vacancy</h1>
    <hr class="underliner">
    ...
    <div class="d-flex justify-center my-6">
        <a href="<?php echo BASE_URL?>/pages/candidate/apply-job.php?jobId=<?php echo $row['jobId'] ?>" class="btn button-filled w-48 mx-4">Apply</a>
    </div>
