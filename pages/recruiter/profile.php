...
<?php
    ...
    // Utils Funcs
    function getCandidateData($recId){
        global $conn;
    ...
    function main(){
        ...
        $candidateDetails = getCandidateData($recId);
...
<body>
    ...
    <main id="container">
        ...
        <h1 class="text-center my-4">Recruiter Profile</h1>
        <hr class="underliner">
        <p class="text-center my-6">Here you will find all the recruiter profile settings.</p>

        <br><br>

        <div id="content" class="d-flex">
            
            <form action="<?php echo BASE_URL?>/utils/recruiter/update-profile.php" method="post" enctype="multipart/form-data">
                <div class="details">
                    <div class="input-box">
                    ...
                    <div class="input-box">
                        <label>Phone</label>
                        <input type="text" class="inner" name="phone" placeholder="Enter your Phone Number" value="<?php echo $candidateDetails['contact']?>" required>
                    </div>
